    ...
    override func spec() {
        describe("a body mass sample conversion") {
            context("the output FHIR Observation") {
                ...
                let expectedCoding4 = Coding()
                expectedCoding4.code = FHIRString("HKQuantityTypeIdentifierBodyMass")
                expectedCoding4.display = FHIRString("Body weight")
                expectedCoding4.system = FHIRURL("com.apple.health")
